<?php
			...
			$query = "SELECT userID,concat(firstName,' ',lastName)as fullname , userType,dateOfBirthday FROM users Order by dateOfBirthday ASC;";
			...
			if($exec){
				...
				if($nor>0)
				{	
					echo "<table id='tableUsersASC' border=1 width=100%>
						<tr>
